...
export async function getUserInfo(params: GetUserByIdParams) {
  try {
    ...
    const criteria = [
      { type: "QUESTION_COUNT" as const, count: totalQuestions },
      { type: "ANSWER_COUNT" as const, count: totalAnswers },
      {
      ...
      { type: "TOTAL_VIEWS" as const, count: questionViews?.totalViews || 0 },
    ];
